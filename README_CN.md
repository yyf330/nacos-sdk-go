...
[![Build Status](https://travis-ci.org/yyf330/nacos-sdk-go.svg?branch=master)](https://travis-ci.org/yyf330/nacos-sdk-go) [![Go Report Card](https://goreportcard.com/badge/github.com/yyf330/nacos-sdk-go)](https://goreportcard.com/report/github.com/yyf330/nacos-sdk-go) ![license](https://img.shields.io/badge/license-Apache--2.0-green.svg)
...
使用`go get`安装SDK：
```sh
$ go get -u github.com/yyf330/nacos-sdk-go
```
## 快速使用
* ClientConfig
